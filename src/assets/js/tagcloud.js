...
window.tagcloud = (function(win, doc) { // ns
    ...
    function TagCloud (options) {
        ...
        self.box.style.minHeight = 5+"rem";
        self.box.style.minWidth = 7.5 + "rem";
        for (var j = 0, len = self.items.length; j < len; j++) {
    ...
    TagCloud.prototype = {
        ...
        update: function () {
            ...
            for (var j = 0, len = self.items.length; j < len; j++) {
                ...
                self.items[j].element.style.fontSize = (self.items[j].fontsize)*0.02 + "rem";
                self.items[j].element.style.left = (self.items[j].x + (self.box.offsetWidth - self.items[j].offsetWidth) / 2) / (100 * (self.box.offsetWidth / 750))  + "rem";
                self.items[j].element.style.top = (self.items[j].y + (self.box.offsetHeight - self.items[j].offsetHeight) / 2) / (100 * (self.box.offsetWidth / 750))+ "rem";
